...
const level1925Platforms = [
 ...
 { x: 65, y: 290, sizeWidth: 10, sizeHeight: 10, name: "p7" },
 ...
 { x: 590, y: 160, sizeWidth: 10, sizeHeight: 10, name: "p15" },
];
...
let objects = [
  ...
  {x: 80, y: 580, sizeWidth: 20, sizeHeight: 20, type:  "teleporter", color: "mediumblue", level: 19.5, landX: 150, landY: 10},
  {x: 150, y: 10, sizeWidth: 20, sizeHeight: 20, type:  "exit", color: "mediumblue", level: 19.5},
  {x: 295, y: 0, sizeWidth: 10, sizeHeight: 600, type: "enemy", color: "red", level: 19.5},
  {x: 130, y: 0, sizeWidth: 10, sizeHeight: 600, type: "enemy", color: "red", level: 19.5},
...
function draw() {
  ...
  if (currentLevel === 1) {
    ...
    if (completedGame) {
      ...
      if (rainbowObtained) ctx.fillText("R para color Arcoiris", 380, 380);
    }
  }
